                                    ...
                                    <div class="right_header_info">
                                        <ul>
                                            ...
                                            <li class="tytyu">
                                                ...
                                                <a href="home2.jsp">Cart <img style="margin-right: 15px;" src="icon/2.png" alt="#" />${sessionScope.size}</a>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mapimg">
                                        <div class="text-bg">
                                            <h1>All <br>
                                                ...
                                                One <br>
                                                Shop</h1>
                                            <span>customers can find a wide range of items or services </span>
                                            <a href="#">Buy now</a>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                                <h2> Categories</h2>
                                <ul class="categiri">
                                    <li><a href="category?id=${"0"}">All</a></li>
                            ...
                            <c:forEach items="${requestScope.listP}" var="o">   
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                    <div class="brand-box">
                                        ...
                                        <span style="color: grey">-------------------</span>
                                        <br/>
                                        <h4>Price $<span class="nolmal" style="font-size:21px; color: red">${o.price}</span></h4>
                                    </div>
                                        <a href="buy?id=${o.id}" class="buynow">Add To Cart</a>
                                    <br/>
                                </div>    
                            </c:forEach>
